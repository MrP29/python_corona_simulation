...
class BasicConfigBuilder(ConfigBuilder):
    def __init__(self, *args, **kwargs):
...
class LockDownConfigBuilder(ConfigBuilder):
    def __init__(self, *args, **kwargs):
        #simulation variables
...
class SelfIsolationConfigBuilder(ConfigBuilder):
...
class ReducedInteractionConfigBuilder(ConfigBuilder):
    def __init__(self, *args, **kwargs):
