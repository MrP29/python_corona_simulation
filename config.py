...
class LockDownConfig(DefaultConfig):
    def __init__(self):
        super().__init__()
        self.set_lockdown()
...
class SelfIsoConfig(DefaultConfig):
    def __init__(self):
        super().__init__()
        self.set_self_isolation()
...
class ReducedIntConfig(DefaultConfig):
    def __init__(self):
        super().__init__()
        self.set_reduced_interaction()
